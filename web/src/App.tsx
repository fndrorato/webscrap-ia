...
import ApprovedItems from "./pages/Dashboard/ApprovedItems";
import PendingItems from "./pages/Dashboard/PendingItems";
import DeclinedItems from "./pages/Dashboard/DeclinedItems";
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute redirectPath="/signin" />}>
            ...
            <Route element={<AppLayout />}>
              ...
              <Route path="/declined-items" element={<DeclinedItems />} />
